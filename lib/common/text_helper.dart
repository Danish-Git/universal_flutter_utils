...
class TextHelper {
  ...
  static String getFontFamily(UFUFontFamily fontFamily, UFUFontWeight fontWeight) {
    switch (fontFamily) {
      case UFUFontFamily.roboto:
        return getRobotoFontFamily(fontWeight);
      case UFUFontFamily.montserrat:
  ...
  static TextStyle getTextStyle(Color? textColor, UFUFontWeight? fontWeight, UFUTextSize? textSize, double?  dynamicFontSize, UFUFontFamily? fontFamily,TextOverflow? overflow, double? height, double? letterSpacing,TextDecoration? textDecoration, FontStyle? fontStyle) {
    return TextStyle(
      color: textColor ?? AppTheme.themeColors.text,
      fontSize: dynamicFontSize ?? getTextSize(textSize ?? UFUTextSize.heading4),
      fontFamily: getFontFamily(fontFamily ?? UFUFontFamily.roboto, fontWeight ?? UFUFontWeight.regular),
